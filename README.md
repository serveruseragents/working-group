...
[Server Link](https://discord.gg/wTewFzfNsM)
...
[Server User-Agents Subreddit](https://www.reddit.com/r/ServerUserAgents/)
...
1. **Related Projects & Ecosystem Map** \- crowd sourcing a list of projects related to or embodying some aspect of SUA’s so that we can start finding the intersections  
2. **User Stories Collection** \- crowd sourcing user stories of what you could do with an SUA so that we start collectively visioning what it should (and maybe shouldn’t) do
...
[https://github.com/serveruseragents/working-group/blob/main/meeting-minutes/2025-11-18-minutes.md](https://github.com/serveruseragents/working-group/blob/main/meeting-minutes/2025-11-18-minutes.md)  
